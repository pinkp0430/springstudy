...
public TicketAllDto(String continent, int price, String c_code, String c_name, Timestamp dep_time, int ticket_id,
			String flight_code, String departure, String dep_name, String arrive, String country, Timestamp flight_time,
			Timestamp arri_time, int seat_able, String md) {
		super();
