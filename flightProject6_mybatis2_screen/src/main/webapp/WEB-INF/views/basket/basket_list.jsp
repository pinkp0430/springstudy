...
<!--			<td><a href="basket_login_check?id=${dto.ticket_id}&count=${dto.seat_buy}">결제</a></td>   -->
			<td><a href="pay_confirm?id=${dto.ticket_id}&count=${dto.seat_buy}&price=${dto.price}">결제</a></td> 
		</tr>	
	</c:forEach>
